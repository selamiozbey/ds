package net.VariousDataStructure;

public class MyStack {

    /*
    *
    * Java provides an inbuilt object type called Stack. It is a collection that is based on the last in first out
    * (LIFO) principle. On Creation, a stack is empty.
...
2. Object pop() : Removes and returns the top element of the stack. An ‘EmptyStackException’ exception is thrown if we
call pop() when the invoking stack is empty.
